...
gulp.task('build', gulpsync.async([
    ['pug-lint', ['clean', 'clean-dev', 'replacePlaceholder', 'pug-build', 'sass-build', 'images-general-build', 'images-content-build', 'images-svgSprite-build', 'js-build-custom', 'js-build', 'fonts-build']]
]));
...
gulp.task('build-all', gulpsync.async([
    ['clean-dev', 'clean', 'pug-lint', 'build-all-enum']
]));
